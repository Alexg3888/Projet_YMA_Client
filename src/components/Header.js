                    ...
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className={'nav-item ' + isActive('/panier')}>
                            <Link className='nav-link' to="/panier">
                                <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-basket2 mr-2 mb-1"
