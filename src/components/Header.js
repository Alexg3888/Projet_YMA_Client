                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className={'nav-item ' + isActive('/panier')}>
                            <Link className='nav-link' to="/panier"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-basket2 mr-2 mb-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
