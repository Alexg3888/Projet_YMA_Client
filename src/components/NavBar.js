  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-white">
      ...
      <Link className="navbar-brand d-none d-lg-block" to="/">
        <img src="/HomePage/logo_nav.png" className="d-block w-100" alt="..." />
      </Link>
      {/*FIN logo*/}
                    ...
                    >
                      <ul className="list-unstyled">
                        ...
                        <li className={"nav-item " + isActive("/burger")}>
                          <Link className="nav-link" to="/burger">
                            Burger
                          </Link>
                        </li>
                        <li className={"nav-item " + isActive("/tapas")}>
                          <Link className="nav-link" to="/tapas">
                            Tapas
                          </Link>
                        </li>
                        <li className={"nav-item " + isActive("/boisson")}>
                          <Link className="nav-link" to="/boisson">
                            Boisson
                          </Link>
                        </li>
              ...
              <div className="row">
                <div className="col d-flex align-items-center">
                  {props.loginState && (
                    <li
                      className={
                        "text-center nav-item " + isActive("/utilisateur")
                      }
                    >
                      <Link className="nav-link" to="/utilisateur">
                        Mon compte
                      </Link>
                    </li>
                  )}
