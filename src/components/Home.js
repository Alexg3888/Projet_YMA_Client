        ...
        <div className="row mt-5">
          <div className="col mt-4">
            ...
            <p>
              ...
              ses frites fraîches maison et ses boisson et dessert maison. Le
      ...
      <div className="container">
        <div className="row mt-4">
          <div className="col mt-4">
            <Link to="/pizza">
              <img
                src="/HomePage/bannièrepizza.jpg"
                alt="..."
          ...
          <div className="col mt-4">
            <Link to="/burger">
              <img
                src="/HomePage/bannièreburger.jpg"
                alt="..."
                className="img-thumbnail"
              />
            </Link>
          ...
          <div className="col mt-4">
            <Link to="/boisson">
              <img
                src="/HomePage/bannièreboisson.jpg"
                alt="..."
                className="img-thumbnail"
              />
            </Link>
          ...
          <div className="col mt-4">
            <Link to="/dessert">
              <img
                src="/HomePage/bannièredessert.jpg"
                alt="..."
                className="img-thumbnail"
              />
            </Link>
