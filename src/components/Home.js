    ...
    <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
      ...
      {/* <!-- Fin picto zone --> */}
        ...
        <div className="row mt-4">
          <div className="col mt-4"><img src="/HomePage/bannièrepizza.jpg" alt="..." className="img-thumbnail"/></div>
          <div className="col mt-4"><img src="/HomePage/bannièreburger.jpg" alt="..." className="img-thumbnail"/></div>
          <div className="w-100"></div>
          <div className="col mt-4"><img src="/HomePage/bannièreboisson.jpg" alt="..." className="img-thumbnail"/></div>
          <div className="col mt-4"><img src="/HomePage/bannièredessert.jpg" alt="..." className="img-thumbnail"/></div>
        </div>
      </div>
